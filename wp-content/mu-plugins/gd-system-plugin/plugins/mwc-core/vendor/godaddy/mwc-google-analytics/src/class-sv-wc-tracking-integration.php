...
class SV_WC_Tracking_Integration extends \WC_Integration {
	...
	/** @var Framework\SV_WC_API_Base the API instance */
	protected $api;
	...
	public function __construct( $id, $title, $description ) {
		...
		if ( $this->has_event( 'removed_from_cart' ) ) {
			...
			if ( Framework\SV_WC_Plugin_Compatibility::is_wc_version_lt( '3.7' ) ) {
		...
		// 404 error
		if ( $this->has_event( '404_error' ) ) {
			add_action( 'template_redirect', [ $this, 'track_404_error' ] );
		}
	...
	public function init_form_fields() {
		...
		$this->form_fields = [
			...
			'changed_cart_quantity_event_name' => [
			...
			'provided_billing_email_event_name' => [
			...
			'selected_payment_method_event_name' => [
			...
			'404_error_event_name' => [
				'title'       => __( '404 Error', 'woocommerce-google-analytics-pro' ),
				'description' => __( 'Triggered when a 404 ("Not Found") error occurs.', 'woocommerce-google-analytics-pro' ),
				'type'        => 'text',
				'default'     => '404 error',
			],
		];
		...
		if ( $this->supports_property_names() ) {
			...
			$this->form_fields = array_merge( $this->form_fields, [
				...
				'purchased_product_sku_property_name' => [
				...
				'purchased_product_name_property_name' => [
				...
				'purchased_product_category_property_name' => [
				...
				'purchased_product_price_property_name' => [
				...
				'purchased_product_qty_property_name' => [
	...
	public function load_events_and_properties() {
		...
		foreach ( $this->settings as $key => $value ) {
			...
			if ( Framework\SV_WC_Helper::str_ends_with( $key, 'event_name' ) ) {
			...
			} elseif ( Framework\SV_WC_Helper::str_ends_with( $key, '_property_name' ) ) {
