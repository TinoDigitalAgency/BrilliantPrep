...
class GoogleAnalytics implements ConditionalComponentContract
{
    ...
    {
        // @TODO: Update with the real implementation (MWC-2500) when this feature is ready to be shipped {@acastro1 2021-09-21}
        return Configuration::get('features.google_analytics', false);
    }
