...
class GoDaddyBranding implements RenderableContract
{
    ...
    public function render()
    {
        ...
        <img id="mwc-gd-branding" class="mwc-gd-branding" src="<?php echo esc_url(WordPressRepository::getAssetsUrl('images/branding/provided-by-gd.svg')); ?>"
             alt="<?php esc_attr_e('Provided by GoDaddy', 'mwc-core'); ?>" />
        <?php
    }
}
