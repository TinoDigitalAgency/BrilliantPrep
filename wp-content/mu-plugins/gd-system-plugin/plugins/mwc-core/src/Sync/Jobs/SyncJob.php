 ...
 * @since 2.13.0
 */
class SyncJob implements ModelContract
{
    ...
    private static $prefix = 'mwc_sync_job_';
    ...
    public static function get($id)
    {
        ...
        if (! ArrayHelper::accessible($result)) {
            return null;
        }

        if (! $data = json_decode(ArrayHelper::get($result, 'value'), true)) {
            return null;
        }
